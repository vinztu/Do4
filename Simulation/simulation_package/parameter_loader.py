from .helper.phase_definitions import phase_definitions

def load_parameters_common(road_network, ext_dict):

    # for cityflow engine ########################### INCREASE
    thread_num = 1
    ...
    # simulation duration
    sim_duration = 4000 if road_network == "Manhattan" else 1600
...
def load_parameters_LDPP(algorithm, common_params):
    ...
    # Compare Consensus solution to the centralized computed solution
    compare_global = True
    ...
    if "LDPP-T" in algorithm:
        ...
        lane_weight = "traffic_dependent" #"traffic_dependent" # constant or traffic_dependent
        V = 10
